...
class VideoAnalysis(models.Model):
    ...
    video_url = models.URLField(max_length=500, help_text="URL of the video to be analyzed")
    ...
    # Metadata
    title = models.CharField(max_length=500, blank=True, null=True, help_text="Title of the video")
    duration_seconds = models.IntegerField(blank=True, null=True, help_text="Duration of the video in seconds")
    language_code = models.CharField(max_length=10, blank=True, null=True, help_text="Language code of the video's audio")
    
    # Transcription
    transcript = models.TextField(blank=True, null=True, help_text="Transcription of the video's audio")
    
    # Analysis
    sentiment = models.CharField(max_length=10, blank=True, null=True, choices=SentimentChoices.choices, help_text="Sentiment of the video content")
    sentiment_score = models.FloatField(blank=True, null=True, help_text="Score representing the sentiment strength")
    tone = models.CharField(max_length=100, blank=True, null=True, help_text="Tone of the video content")
